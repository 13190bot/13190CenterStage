...
public class DriveConstants {
    ...
    public static double kStatic = 0.024; // 0.024 best motion profile, but 0.18 most accurate for distance
    ...
    public static double MAX_ANG_ACCEL = Math.toRadians(170.989918);
